...
import { DEFAULT_SEAT_COUNT, MAX_SEATS_PER_TABLE, MIN_SEATS_PER_TABLE } from './constants';
...
function sanitizeState(state: EventState): EventState {
 ...
 */
export function parseEventState(parsed: unknown): EventState | null {
  try {
